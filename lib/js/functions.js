...
// $('.picture').tooltip({show: {effect:"none", delay:0}});



// $(".thumbnail_picture").on("mouseover", function () {
//   // console.log($(this))
//   if($(this).hasClass('thumbnail_picture')){
//     var value = $(this).next('div:hidden').html();
//     var title = $(this).attr('title');
//     $('.thumbnail_picture').qtip({
...
// $('a').each(function() {
//   if($(this).hasClass('thumbnail_picture')){
//     // var v = $(this).next('div:hidden')
//     // var value = $(this).nextUntil('div:hidden');
//     var value = $(this).next('div:hidden').html();
//     var title = $(this).attr('title');
//     console.log($(title));
//     console.log($(value));
...
//    $('.thumbnail_picture').each(function()
//    {
